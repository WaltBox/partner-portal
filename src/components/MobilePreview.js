...
const MobilePreview = ({ partner }) => {
  ...
  <div className="h-[100px] bg-gray-100 overflow-hidden">
    ...
    />
        ...
        <div className="mt-10 p-3 text-center">
          ...
          <p className="text-xs text-gray-600 mt-1 line-clamp-2">{partner?.description || 'Company description will appear here'}</p>
        </div>
      </div>
    </div>
  );
  ...
  const DetailView = () => (
    <div className="h-full bg-gray-50 animate-slideUp">
      ...
      <div className="relative px-4 -mt-10">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl shadow-lg p-4">
            ...
            <p className="text-sm text-gray-600">{partner?.about || 'About text will appear here'}</p>
          </div>
        </div>
      </div>
